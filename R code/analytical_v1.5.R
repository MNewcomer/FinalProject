...
ARS_testing(ARS_values,density)
...
ARS_testing(ARS_values1,density1)
...
ARS_testing(ARS_values2,density2)
...
ARS_testing(ARS_values3,density3)
...
ARS_testing(ARS_values4,density4)
...
ARS_testing <- function(sample,density){
